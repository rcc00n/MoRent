const ru = {
  ...
  catalog: {
    ...
    visuals: {
      primaryAlt: 'Эффектный прибрежный мост и тихоокеанский горизонт для премиальных маршрутов',
      primaryCaption: 'Отдельный прибрежный маршрут, который даёт странице автопарка собственный образ',
    },
    infoCards: [
      {
